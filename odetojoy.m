...
[tnote, dnote, anote, inote] = roundmusic(tnote, dnote, anote, inote, 1, 20);

tnote = [tnote, 14.5, 14.5, 14.5, 15.25, 15.25, 15.25, 15.5, 15.5, 15.5];

dnote = [dnote, 0.9, 0.9, 0.6, 0.3, 0.3, 0.3, 1.2, 1.2, 1.2];

anote = [anote, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8];

inote = [inote, 18, 11, 9, 16, 11, 8, 16, 11, 8];

tnote = [tnote, 16.5, 16.5, 16.5, 17, 17.5, 17.5, 17.5, 18, 18.5, 18.5, 18.5, 18.75, 19, 19.5, 19.5, 19.5, 20];

dnote = [dnote, 0.6, 1.2, 1.2, 0.6, 0.6, 1.2, 1.2, 0.6, 0.6, 1.2, 1.2, 0.3, 0.3, 0.6, 1.2, 1.2, 0.6];

anote = [anote, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8];

inote = [inote, 18, 11, 3, 18, 20, 11, 4, 16, 18, 11, 3, 20, 21, 20, 11, 4, 16];

tnote = [tnote, 20.5, 20.5, 20.5, 20.75, 21, 21.5, 21.5, 22, 22.5, 22.5, 23, 23, 23.5];

dnote = [dnote, 0.6, 1.2, 1.2, 0.3, 0.3, 0.6, 1.2, 0.6, 0.6, 0.6, 0.6, 0.6, 1.2];

anote = [anote, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8];

inote = [inote, 18, 11, 3, 20, 21, 20, 12, 18, 16, 13, 18, 10, 11];

[tnote, dnote, anote, inote] = roundmusic(tnote, dnote, anote, inote, 25, 53);
